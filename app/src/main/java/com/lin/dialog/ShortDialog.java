...
/**
 * Created by chenhailin on 2018/6/6.
 */
...
public class ShortDialog {
    public static class Builder implements BuilderInterface {
        ...
        public Builder setNegativeButton(@Nullable String text,@ColorRes int color , @Nullable OnNegativeListener listener) {
            mParams.setNegativeListener(listener);
            mParams.setNegativeText(text);
            mParams.setNegativeColor(color);
            return this;
        }
        ...
        public Builder setPositiveButton(@Nullable String text, @ColorRes int textcolor, @Nullable OnPositiveListener listener) {
            mParams.setPositiveListener(listener);
            mParams.setPositiveText(text);
            mParams.setPositiveTextcolor(textcolor);
            return this;
        }
    ...
    private static class Controller implements View.OnClickListener, BuilderInterface {
        ...
        public void setPositiveTextColor(@ColorRes int color) {
            mTvPositive = (TextView) mRootView.findViewById(R.id.dialog_commit);

            if (mTvPositive != null) {
               mTvPositive.setTextColor(mContext.getResources().getColor(color));
            }
        }

        public void setNegativeTextColor(int mNegativeTextColor) {
            mTvNegative = (TextView) mRootView.findViewById(R.id.dialog_cancel);
            if (mTvNegative != null) {
                mTvNegative.setTextColor(mContext.getResources().getColor(mNegativeTextColor));
            }
        }
    ...
    private static class ControllerParams {
        ...
        private  int  mPostiveTextColor=-1;
        ...
        private void apply(Controller controller, Dialog dialog) {
            ...
            if (mPositiveText != null && mPositiveListener != null) {
                ...
                if (mPostiveTextColor!=-1) {
                    controller.setPositiveTextColor(mPostiveTextColor);
                }
            }
            if (mNegativeText != null && mNegativeListener != null) {
                ...
                if (mNegativeTextColor!=-1) {
                    controller.setNegativeTextColor(mNegativeTextColor);
                }
            }
            if (mIconId != -1) {
        ...
        public void setPositiveTextcolor(int textcolor) {
            mPostiveTextColor=textcolor;
        }
